...
@pytest.fixture(name="set_up_rootlogger", autouse=True)
def fixture_set_up_rootlogger(tmpdir):
...
class TestDeploymentLogger:
    def test_logger(self, caplog, set_up_rootlogger):
        log_file = set_up_rootlogger
        log.info("Foobar")
